...
export const ui = {
  fr: {
    ...
    'prog.complete': 'Programme complet',
    'prog.complete_view': 'Voir le programme complet',
    'prog.activities': 'activités',
    'prog.activity': 'activité',
    'prog.back': 'Retour au programme',
    'prog.soon': 'Le programme détaillé sera bientôt disponible.',
    'prog.films': 'Films',
    'prog.download_pdf': 'Télécharger le PDF',
    'prog.view_pdf': 'Programme officiel (PDF)',
    'prog.no_pdf': 'Le PDF officiel du programme sera mis en ligne prochainement.',
    'prog.see_day': 'Voir le détail →',
    'prog.web_title': 'Programme détaillé',
  ...
  en: {
    ...
    'nav.contacts': 'Contacts',
    'nav.newsletter': 'Newsletter',
    'prog.complete': 'Full programme',
    'prog.complete_view': 'View the full programme',
    'prog.activities': 'activities',
    'prog.activity': 'activity',
    'prog.back': 'Back to programme',
    'prog.soon': 'The detailed programme will be available soon.',
    'prog.films': 'Films',
    'prog.download_pdf': 'Download the PDF',
    'prog.view_pdf': 'Official programme (PDF)',
    'prog.no_pdf': 'The official programme PDF will be published soon.',
    'prog.see_day': 'See details →',
    'prog.web_title': 'Detailed programme',

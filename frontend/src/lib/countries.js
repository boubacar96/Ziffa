// Liste des pays (FR / EN) pour les menus déroulants des formulaires.
export const COUNTRIES = [
  ...
  { fr: 'Birmanie (Myanmar)', en: 'Myanmar' },
...
export function countryNames(lang) {
  return COUNTRIES.map((c) => (lang === 'en' ? c.en : c.fr));
}

...
export interface ApiFilmFilm extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['fiction', 'documentaire', 'animation', 'court-metrage']
    >;
...
export interface ApiFormationFormation extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Formation permanente';
  ...
  attributes: {
    ...
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['documentaire', 'animation']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currentEditionLabel: Schema.Attribute.String;
    ...
    pressEmail: Schema.Attribute.Email;
    publishedAt: Schema.Attribute.DateTime;
    siteName: Schema.Attribute.String & Schema.Attribute.DefaultTo<'ZIFFA'>;
    tagline: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPersonPerson extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Personne (jury / \u00E9quipe)';
    pluralName: 'people';
    singularName: 'person';
  };
  options: {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['jury', 'equipe', 'invite']> &
      Schema.Attribute.DefaultTo<'jury'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
